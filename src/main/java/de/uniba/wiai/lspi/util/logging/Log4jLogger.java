...
public class Log4jLogger extends Logger {
	 ...
	 * log4j properties.
	 */
    public final static String PROPERTIES_FILE_LOGGING_CONFIG = "log4j.properties.file";

    /** The STANDARD_PROPERTY_FILE */
    public final static String STANDARD_LOGGING_CONFIG = "log4j.properties";
    ...
    private static void configure()
    {
        if (!configured)
        {
            ...
            String file = STANDARD_LOGGING_CONFIG;

            try
            {
                if (System.getProperty(PROPERTIES_FILE_LOGGING_CONFIG) != null
                    && System.getProperty(PROPERTIES_FILE_LOGGING_CONFIG).length() > 0)
                {
                    file = System.getProperty(PROPERTIES_FILE_LOGGING_CONFIG);
                }

                configURL = ClassLoader.getSystemClassLoader().getResource(file);
                if (configURL != null)
                {
                    ...
                    System.out.println("[" + Thread.currentThread().getName() + "] " + "INFO "
                                       + Log4jLogger.class.getName() + " - log4j configured with '"
                                       + file + "'.");
                }
                else
                {
                    ...
                    System.out.println("[" + Thread.currentThread().getName() + "] " + "INFO "
                                       ...
                                       + " - log4j configured with basic configuration.");
                }

                System.out.println("[" + Thread.currentThread().getName() + "] " + "INFO "
                                   + Log4jLogger.class.getName() + " - Logging is On.");
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#debug(java.lang.Object)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#debug(java.lang.Object, java.lang.Throwable)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#info(java.lang.Object)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#info(java.lang.Object, java.lang.Throwable)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#warn(java.lang.Object)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#warn(java.lang.Object, java.lang.Throwable)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#error(java.lang.Object)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#error(java.lang.Object, java.lang.Throwable)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#fatal(java.lang.Object)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#fatal(java.lang.Object, java.lang.Throwable)
     */
	@Override
    ...
    /**
     * @see de.uniba.wiai.lspi.util.logging.Logger#isEnabledFor(de.uniba.wiai.lspi.util.logging.Logger.LogLevel)
     */
	@Override
